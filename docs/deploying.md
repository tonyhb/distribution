...
You should usually consider using [another storage backend](https://github.com/tonyhb/distribution/blob/master/docs/storagedrivers.md) instead of the local filesystem. Use the [storage configuration options](https://github.com/tonyhb/distribution/blob/master/docs/configuration.md#storage) to configure an alternate storage backend.
